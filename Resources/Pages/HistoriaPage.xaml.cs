    ...
    public partial class HistoriaPage : ContentPage
    {
        ...
        private void CargarPreguntas()
        {
            try
            {
                ...
                var resourceName = "MauiProyecto.Resources.preguntas.preguntas_historia.json"; // Ruta completa al recurso JSON
        ...
        private async void OnValidateClicked(object sender, EventArgs e)
        {
            if (preguntaActual < preguntas?.Count)
            {
                ...
                else
                {
                    ...
                    ResultadosGlobales.AgregarResultado("Historia", aciertos, errores);
                    ...
                    await Navigation.PushAsync(new LogicaPage()); // Si esta es la última materia, se puede mostrar un resumen
                }
            }
            else
            {
