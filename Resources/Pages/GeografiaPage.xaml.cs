...
{
    public partial class GeografiaPage : ContentPage
    {
        ...
        private void CargarPreguntas()
        {
            try
            {
                ...
                var resourceName = "MauiProyecto.Resources.preguntas.preguntas_geografia.json"; // Ruta completa al recurso JSON
        ...
        private async void OnValidateClicked(object sender, EventArgs e)
        {
            if (preguntaActual < preguntas?.Count)
            {
                ...
                else
                {
                    ...
                    await Navigation.PushAsync(new HistoriaPage()); // Si esta es la última materia, se puede mostrar un resumen
                }
            }
            else
            {
