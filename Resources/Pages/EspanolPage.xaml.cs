...
{
    public partial class EspanolPage : ContentPage
    {
        ...
        private void CargarPreguntas()
        {
            try
            {
                ...
                var resourceName = "MauiProyecto.Resources.preguntas.preguntas_espanol.json"; // Ruta completa al recurso JSON
        ...
        private async void OnValidateClicked(object sender, EventArgs e)
        {
            if (preguntaActual < preguntas?.Count)
            {
                ...
                else
                {
                    ...
                    ResultadosGlobales.AgregarResultado("Español", aciertos, errores);
                    ...
                    // Navegar a la siguiente materia o a una página de revisión general
