    ...
    public partial class FisicaPage : ContentPage
    {
        ...
        private void CargarPreguntas()
        {
            try
            {
                ...
                var resourceName = "MauiProyecto.Resources.preguntas.preguntas_fisica.json"; // Ruta completa al recurso JSON
        ...
        private async void OnValidateClicked(object sender, EventArgs e)
        {
            if (preguntaActual < preguntas?.Count)
            {
                ...
                else
                {
                    ...
                    ResultadosGlobales.AgregarResultado("Física", aciertos, errores);
                    ...
                    await Navigation.PushAsync(new GeografiaPage()); // Si esta es la última materia, se puede mostrar un resumen
                }
            }
            else
            {
