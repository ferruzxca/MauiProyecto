    ...
    public partial class QuimicaPage : ContentPage
    {
        ...
        private void CargarPreguntas()
        {
            try
            {
                ...
                var resourceName = "MauiProyecto.Resources.preguntas.preguntas_quimica.json"; // Ruta completa al recurso JSON
        ...
        private async void OnValidateClicked(object sender, EventArgs e)
        {
            if (preguntaActual < preguntas?.Count)
            {
                ...
                else
                {
                    ...
                    ResultadosGlobales.AgregarResultado("Química", aciertos, errores);
                    ...
                    // Aquí puedes navegar a la siguiente página de materia, por ejemplo, la página de Física
                    await Navigation.PushAsync(new FisicaPage());
                }
            }
            else
            {
