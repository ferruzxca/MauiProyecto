...
{
    public partial class LogicaPage : ContentPage
    {
        ...
        private void CargarPreguntas()
        {
            try
            {
                ...
                var resourceName = "MauiProyecto.Resources.preguntas.preguntas_logica.json"; // Ruta completa al recurso JSON
        ...
        private async void OnValidateClicked(object sender, EventArgs e)
        {
            if (preguntaActual < preguntas?.Count)
            {
                ...
                else
                {
                    ...
                    ResultadosGlobales.AgregarResultado("Lógica", aciertos, errores);
                    ...
                    await Navigation.PushAsync(new ReviewPage()); // Si esta es la última materia, se puede mostrar un resumen
                }
            }
            else
            {
