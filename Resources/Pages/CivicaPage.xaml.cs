...
{
    public partial class CivicaPage : ContentPage
    {
        ...
        private void CargarPreguntas()
        {
            try
            {
                ...
                var resourceName = "MauiProyecto.Resources.preguntas.preguntas_civica.json"; // Ruta completa al recurso JSON
        ...
        private async void OnValidateClicked(object sender, EventArgs e)
        {
            if (preguntaActual < preguntas?.Count)
            {
                ...
                else
                {
                    ...
                    ResultadosGlobales.AgregarResultado("Cívica", aciertos, errores);
                    ...
                    await Navigation.PushAsync(new ComputacionPage()); // Si esta es la última materia, se puede mostrar un resumen
                }
            }
            else
            {
